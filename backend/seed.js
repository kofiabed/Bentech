...
async function seed() {
  try {
    ...
    const { error: deleteErr } = await supabase.from('products').delete().neq('id', '00000000-0000-0000-0000-000000000000');
    if (deleteErr) console.warn('Warning deleting products:', deleteErr.message);
